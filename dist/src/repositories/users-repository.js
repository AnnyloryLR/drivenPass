...
function getUserData(email) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, config_1.default.user.findFirst({
                        where: {
                            email: email
                        }
                    })];
...
function signIn(signInData) {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, registeredUser, logIn;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    email = signInData.email, password = signInData.password;
                    return [4 /*yield*/, config_1.default.user.findFirst({
                            where: {
                                email: email
                            }
                        })];
                case 1:
                    ...
                    logIn = bcrypt_1.default.compareSync(registeredUser.password, password);
                    return [2 /*return*/, { registeredUser: registeredUser, logIn: logIn }];
            }
        });
    });
}
